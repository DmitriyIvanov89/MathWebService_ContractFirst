...
public class ObjectFactory {
    ...
    private final static QName _CommonFault_QNAME = new QName("http://math.ws.divanov", "commonFault");
     ...
     */
    @XmlElementDecl(namespace = "http://math.ws.divanov", name = "commonFault")
    public JAXBElement<ErrorResponse> createCommonFault(ErrorResponse value) {
        return new JAXBElement<ErrorResponse>(_CommonFault_QNAME, ErrorResponse.class, null, value);
    }
