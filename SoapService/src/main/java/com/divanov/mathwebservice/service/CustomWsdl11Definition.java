...
public class CustomWsdl11Definition extends DefaultWsdl11Definition {
    private String exceptionFaultSuffix;
    ...
    public void setFaultSuffix(String faultSuffix) {
        ...
        this.exceptionFaultSuffix = faultSuffix;
    }

    private boolean isFaultMessage(Message message) {
        String messageName = message.getQName().getLocalPart();
        return messageName != null && messageName.contains(exceptionFaultSuffix);
    }
