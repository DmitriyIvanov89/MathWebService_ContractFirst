...
public class MathService {
    ...
    public QuadraticEducationResponse createQuadraticEducationSolutionResult(QuadraticEducationRequest request) throws QuadraticEducationNoSolutionException {
