...
public class MathWSEndpoint {
    ...
    @ResponsePayload
    public QuadraticEducationResponse createQuadraticEducationSolutionResult(@RequestPayload QuadraticEducationRequest request) throws QuadraticEducationNoSolutionException {
