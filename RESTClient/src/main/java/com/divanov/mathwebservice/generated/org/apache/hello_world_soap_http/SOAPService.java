...
public class SOAPService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/C:/Users/dmitriy.a.ivanov/Downloads/MyRepos/MathWebService_ContractFirst/RESTClient/src/main/resources/test.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(SOAPService.class.getName())
                .log(java.util.logging.Level.INFO,
                     "Can not initialize the default wsdl from {0}", "file:/C:/Users/dmitriy.a.ivanov/Downloads/MyRepos/MathWebService_ContractFirst/RESTClient/src/main/resources/test.wsdl");
        }
        WSDL_LOCATION = url;
    }
